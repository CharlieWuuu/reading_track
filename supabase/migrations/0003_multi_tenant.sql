...
INSERT INTO "users" ("email") VALUES ('charliewu500@gmail.com') ON CONFLICT ("email") DO NOTHING;
--> statement-breakpoint
ALTER TABLE "attributes" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "book_types" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "keywords" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "settings" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "writing_types" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "articles" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "books" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "readings" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "metrics" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "writings" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "vocabulary" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "article_keywords" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "book_keywords" ADD COLUMN "user_id" uuid;--> statement-breakpoint
ALTER TABLE "writing_keywords" ADD COLUMN "user_id" uuid;--> statement-breakpoint
UPDATE "attributes" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "book_types" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "keywords" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "settings" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "writing_types" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "articles" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "books" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "readings" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "metrics" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "writings" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "quotes" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "vocabulary" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "article_keywords" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "book_keywords" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
UPDATE "writing_keywords" SET "user_id" = (SELECT "id" FROM "users" WHERE "email" = 'charliewu500@gmail.com');--> statement-breakpoint
ALTER TABLE "attributes" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "book_types" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "keywords" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "settings" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "writing_types" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "articles" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "books" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "readings" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "metrics" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "writings" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "quotes" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "vocabulary" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "article_keywords" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "book_keywords" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
ALTER TABLE "writing_keywords" ALTER COLUMN "user_id" SET NOT NULL;--> statement-breakpoint
