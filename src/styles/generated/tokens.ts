...
export const TOKENS = {
  ...
  "ash-100": "#e6e5e2",
  "ash-300": "#c2c0ba",
  "ash-500": "#6b6a64", // 淡墨，取自靜野封面配色；白底對比 5.4:1
  "ash-700": "#4c4b46",
  "plum-100": "#ece2e6",
  "plum-300": "#c9aebb",
  "plum-500": "#9c6b80",
  "plum-700": "#764f61", // 延伸自靜野色系的梅紫，白底對比 6.9:1
  "straw-100": "#f6efd9",
  "straw-300": "#e6d59f",
  "straw-500": "#c7a94a", // 白底只有 2.3:1，只做圖表與色塊，不拿來寫字
  "straw-700": "#836826", // 延伸自靜野色系的若線黃，白底對比 5.3:1
  "blue-100": "#dce6f1",
  "blue-200": "#cfe0ef",
  "blue-300": "#b9cde2",
  "blue-400": "#a9c2da",
