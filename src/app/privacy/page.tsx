...
export const metadata: Metadata = {
  title: "隱私權政策｜Reading Track",
  description: "Reading Track 如何處理你的資料",
};
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 py-8 text-sm leading-relaxed text-gray-700">
      ...
      <section className="space-y-2">
        ...
        <p>
          Reading Track 使用 Google 帳號登入，並在你授權後存取你指定的那份 Google
      ...
      <section className="space-y-2">
        ...
        <p>
          ...
          移除 Reading Track。你的閱讀紀錄在你自己的試算表中，刪除該試算表即可刪除全部內容。
        </p>
      </section>
