...
const styles = {
  ...
  field: "flex items-center gap-1 rounded border px-3 py-2",
  input: "min-w-0 flex-1 text-sm outline-none",
  clear: "shrink-0 rounded p-0.5 text-gray-400 hover:bg-gray-100 hover:text-red-600",
  panel:
    "absolute z-50 mt-1 max-h-56 w-full overflow-y-auto rounded-lg border bg-white py-1 shadow-lg",
  item: "flex w-full items-center gap-2 px-3 py-1.5 text-left text-sm hover:bg-gray-50",
  cover: "h-8 w-[22px] shrink-0 rounded-sm object-cover",
  blank: "h-8 w-[22px] shrink-0 rounded-sm bg-gray-100",
